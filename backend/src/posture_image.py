...
def process(input_image, params, model_params):
    ...
    multiplier = [
        x * model_params["boxsize"] / oriImg.shape[0] for x in params["scale_search"]
    ]
...
def calcAngle(a, b):
    ...
    try:
        ...
        result_string += "unable to calculate angle"
...
def checkHandFold(all_peaks):
    ...
    try:
            ...
            try:
                if all_peaks[4][0][0:2]:
                    distance = calcDistance(
                        all_peaks[3][0][0:2], all_peaks[4][0][0:2]
                    )  # distance between right arm-joint and right palm.
                    armdist = calcDistance(
                        all_peaks[2][0][0:2], all_peaks[3][0][0:2]
                    )  # distance between left arm-joint and left palm.
                    if distance < (armdist + 100) and distance > (
                        ...
                        result_string += "Not Folding Hands"
                    else:
                        print("Folding Hands")
                        result_string += "Folding Hands"
            except Exception as e:
                print("Folding Hands")
                result_string += "unable to calculate angle"
    except Exception as e:
        try:
            ...
            result_string += "Unable to detect arm joints"
...
def calcDistance(a, b):  # calculate distance between two points.
    ...
    try:
        ...
        result_string += "Unable to calculate distance"
...
def checkKneeling(all_peaks):
    ...
    try:
        ...
        if (
            ...
            result_string += "Both Legs are in Kneeling"
        elif rightdegrees > 60:
            print("Right leg is kneeling")
            result_string += "Right leg is kneeling"
        elif leftdegrees > 60:
            print("Left leg is kneeling")
            result_string += "Left leg is kneeling"
        else:
            print("Not kneeling")
            result_string += "Not kneeling"
        ...
        try:
            ...
            if degrees > 60:
                ...
                result_string += "Both Legs Kneeling"
            else:
                print("Not Kneeling")
                result_string += "Not kneeling"
        except Exception as e:
            print("legs not detected")
            result_string += "legs not detected"
...
if __name__ == "__main__":  # main function of the program
    ...
    if vi == False:
        ...
        canvas, position = process(
            "./sample_images/sitting_posture.jpeg", params, model_params
        )
        if position == 1:
            print("Hunchback")
            result_string += "HunchBack"
        elif position == -1:
            print("Reclined")
            result_string += "Reclined"
        else:
            print("Straight")
